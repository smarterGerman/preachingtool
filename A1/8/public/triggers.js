...
{"Computer" : ["Brauchst du meinen neuen Computer?", "Ich brauche deinen dein neuen Computer nicht.", "Was? Du brauchst meinen neuen Computer nicht?", "Nein, ich brauche deinen neuen Computer nicht."],
"Auto" : ["Brauchst du mein neues Auto?", "Ich brauche dein neues Auto nicht.", "Was? Du brauchst mein neues Auto nicht?", "Nein, ich brauche dein neues  Auto nicht."],
"Hose" : ["Brauchst du meine neue Hose?", "Ich brauche deine neue Hose nicht.", "Was? Du brauchst meine neue Hose nicht?", "Nein, ich brauche deine neue Hose nicht."],
...
const triggers = ['Computer', 'Auto', 'Hose', 'Handy', 'Fahrrad', 'Job', 'Gabel', 'Freund', 'Brille', 'Lunge'];
