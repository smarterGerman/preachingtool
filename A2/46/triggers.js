...
{"Computer" : ["Ist das dein Computer?", "Welchen Computer meinst du denn?", "Na der Computer, der so neu aussieht.", "Der Computer, der so neu aussieht, ist nicht meiner."],
...
"Wohnung" : ["Ist das deine Wohnung?", "Welches Auto meinst du denn?", "Na die Wohnung, die so neu aussieht.", "Die Wohnung, die so neu aussieht, ist nicht meine."],
...
"Sonnenbrille" : ["Ist das deine Sonnenbrille?", "Welche Sonnenbrille meinst du denn?", "Na die Sonnenbrille, die so neu aussieht.", "Die Sonnenbrille, die so neu aussieht, ist nicht meine."],
"Anzüge" : ["Sind das deine Anzüge?", "Welche Anzüge meinst du denn?", "Na die Anzüge, die so neu aussehen.", "Die Anzüge, die so neu aussehen, sind nicht meine."]}
]`;

const triggers = ['Computer', 'Auto', 'Handtasche', 'Schuhe', 'Fairphone', 'Wohnung', 'Fahrrad', 'Kleid', 'Sonnenbrille', 'Anzüge'];
