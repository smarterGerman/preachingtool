...
"vor + Tür | hinter + Haus" : ["Wo bist du gerade?", "Ich bin vor der Tür. Warum?", "Könntest du kurz ins Haus kommen? Ich brauche deine Hilfe.", "Kein Problem. Ich komme ins Haus."],
"hinter + Haus | unter + Dusche" : ["Wo bist du gerade?", "Ich bin im Haus. Warum?", "Könntest du kurz in die Dusche kommen? Ich brauche deine Hilfe.", "Kein Problem. Ich komme in die Dusche."],
"unter + Dusche | auf + Klo" : ["Wo bist du gerade?", "Ich bin in der Dusche. Warum?", "Könntest du kurz aufs Klo kommen? Ich brauche deine Hilfe.", "Kein Problem. Ich komme aufs Klo."],
"auf + Klo | auf + Dachboden" : ["Wo bist du gerade?", "Ich bin aufm Klo. Warum?", "Könntest du kurz auf den Dachboden kommen? Ich brauche deine Hilfe.", "Kein Problem. Ich komme auf den Dachboden."]}
]`;
