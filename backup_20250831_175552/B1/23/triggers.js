...
"Kirche | Regierung | umbauen" : ["Ich habe gehört, dass die Kirche umgebaut wird.", "Das stimmt. Die Kirche wird von der Regierung umgebaut.", "Von wem wird die Kirche denn umgebaut?", "Sie wird von der Regierung umgebaut."],
...
"Schulen (pl) | Eltern (pl) | renovieren" : ["Ich habe gehört, dass die Schulen renoviert werden.", "Das stimmt. Die Schulen werden renoviert.", "Von wem werden die Schulen denn renoviert?", "Sie werden von den Eltern renoviert."]}
]`;
